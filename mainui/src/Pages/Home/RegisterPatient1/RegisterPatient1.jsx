...
const RegisterPatient = () => {
    ...
    const submitButton = () => {
        if (inputField.todaydate == '' || inputField.labno == '' || inputField.sampledate == ''
            ...
            || selectedItems.length == 0 || inputField.email == '') {
            alert("Please enter all details !")
        }
        else {
            axios.post(ipofserver + 'regPatient', {
                adminname: localStorage.getItem('LoginUsername'),
                typeofuser: localStorage.getItem('LoginUsertype'),
                todaydate: inputField.todaydate,
                labno: inputField.labno,
                sampledate: inputField.sampledate,
                patientname: inputField.patientname,
                ...
                patientaddress: inputField.patientaddress,
                pincode: inputField.pincode,
                totalamount: inputField.totalamount,
                amountpaid: inputField.amountpaid,
                balanceamount: inputField.balanceamount,
                gender: selectedValue,
                contry: selectedContry,
                state: selectedState,
                city: selectedValue1,
                alltests: selectedItems.join(','),
            })
