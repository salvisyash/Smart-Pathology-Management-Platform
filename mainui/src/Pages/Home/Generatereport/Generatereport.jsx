...
const Generatereport = () => {
    ...
    const acceptButton = (listval, email, personname, labno, gender, age,docname) => {
                        ...
                        <tbody>
                            {userData.map((userdetail, index) => {
                                return <tr key={index}>
                                    ...
                                    <td style={{ width: 300 }}><Button style={{ backgroundColor: 'green', borderColor: 'green' }} onClick={event => acceptButton(userdetail[19], userdetail[9], userdetail[6], userdetail[4], userdetail[15], userdetail[8], userdetail[21])}>Generate report</Button></td>
                                </tr>
                            })}
                        </tbody>
                    </Table>
                        ...
                        <Modal.Body style={{ maxHeight: '400px', overflowY: 'auto' }}>
                            <Row>
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" name="docname" value={inputField.docname} readOnly/>
                                </Form.Group>
                                <Col md={12} lg={12}>
